...
const LaunchRequestHandler = {
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'Tap in to PlagaCloud';
    },
    handle(handlerInput) {
        const speakOutput = 'To listen to PlagaCloud my dude, you need to ask for specific channels. Peep this. Try asking me things such as "play OG Cast on PlagaCloud" or "play The Move on PlagaCloud".';
 ...
 * */
 const ListenToOGCast = {
  ...
  async handle(handlerInput) {
      ...
      const speakOutput = 'Now playing OG Cast, on PlagaCloud.';
      const playBehavior = 'REPLACE_ALL';
      const podcastUrl = 'https://livestream.realtimedoge.com/stream/stream/index.m3u8';
...
const ListenToPlugStream = {
    ...
    async handle(handlerInput) {
        ...
        const speakOutput = 'Now playing PlugStream, on PlagaCloud.';
        const playBehavior = 'REPLACE_ALL';
        const podcastUrl = 'https://livestream.realtimedoge.com/stream/stream2/index.m3u8';
...
const ListenToTheMove = {
  ...
  async handle(handlerInput) {
      ...
      const speakOutput = 'Now playing The Move, on PlagaCloud.';
      const playBehavior = 'REPLACE_ALL';
      const podcastUrl = 'https://livestream.realtimedoge.com/stream/themove/index.m3u8';
...
const ListenToRacoonSaloon = {
  ...
  async handle(handlerInput) {
      ...
      const speakOutput = 'Now playing Racoon Saloon, on PlagaCloud.';
      const playBehavior = 'REPLACE_ALL';
      const podcastUrl = 'https://livestream.realtimedoge.com/stream/racoonsaloon/index.m3u8';
...
const ListenToWCALI = {
  ...
  async handle(handlerInput) {
      ...
      const speakOutput = 'Now playing W Cali, on PlagaCloud.';
      const playBehavior = 'REPLACE_ALL';
      const podcastUrl = 'https://livestream.realtimedoge.com/stream/wcali/index.m3u8';
...
const UnsupportedAudioIntentHandler = {
    ...
    async handle(handlerInput) {
        const speakOutput = 'Ayyy, chill out. I can\'t do that yet.';
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'my dude, you need to ask alexa for a specific PlagaCloud channel.';
...
const CancelAndStopIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'I\'m outie 5 to my dog house. Deuces.';
...
const FallbackIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'ayyyyy, chill. I don\'t know how to move like that yet.';
...
const ErrorHandler = {
    ...
    handle(handlerInput, error) {
        const speakOutput = 'Aye, this weed got me all goofy. Please try again.';
